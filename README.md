...
Here are some of the automated charts generated by the Python script after running the optimization scenarios:

**1. Scenario Cost Comparison**
![Scenario Costs](assets/Chart_1_Scenarios.png)

**2. Financial Breakdown (CAPEX vs OPEX)**
![Financial Breakdown](assets/Chart_2_Financial_Analysis.png)

**3. Facility Capacity Utilization**
![Capacity Utilization](assets/Chart_3_Capacity.png)

**4. Waste Distribution by Category**
![Waste Distribution](assets/Chart_4_Waste_Distribution.png)
---
